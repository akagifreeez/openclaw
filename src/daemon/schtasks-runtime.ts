...
function parseSchtasksQuery(output: string): ScheduledTaskInfo {
  ...
  // Localized numeric result rows (e.g. ja-JP 前回の結果) are intentionally NOT parsed:
  // they fall through to the locale-independent COM state probe instead (fail closed).
